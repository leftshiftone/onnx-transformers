...
from onnx_transformers.__spi__.model import NetworkInfo, TokenizerConfig, EncodingConfig, ModelConfig, \
    TruncationStrategy, PaddingStrategy, EncodingFast
from onnx_transformers.__spi__.types import Input
from onnx_transformers.tokenizer.mixin.special_tokens_mixin import SpecialTokensMixin


class FastTokenizer(SpecialTokensMixin):
